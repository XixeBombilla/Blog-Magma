...
class ArticulosControllerTest < ActionController::TestCase
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post :create, articulo: { autor: @articulo.autor, descripcion: @articulo.descripcion, titulo: @articulo.titulo }
    end
  ...
  test "should update articulo" do
    put :update, id: @articulo, articulo: { autor: @articulo.autor, descripcion: @articulo.descripcion, titulo: @articulo.titulo }
    assert_redirected_to articulo_path(assigns(:articulo))
  end
